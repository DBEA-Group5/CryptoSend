    ...
    <div className="flex flex-col min-h-screen bg-gray-50 p-4 max-w-md mx-auto">
      ...
      <header className="flex justify-between items-center mb-8">
        ...
        <div className="flex space-x-2">
          <Button size="icon" variant="ghost" className="text-gray-500 hover:text-purple-500">
      ...
      <section className="mb-8">
        <h3 className="text-xl font-bold mb-4">My apps</h3>
          ...
          <CardContent className="p-4 space-y-4">
            <Button variant="ghost" className="w-full justify-start hover:bg-purple-50">
              ...
              <div className="text-left">
                ...
                <div className="text-sm text-gray-500">Get started with tutorials</div>
              </div>
            </Button>
            <Button variant="ghost" className="w-full justify-start hover:bg-purple-50">
              ...
              <div className="text-left">
                ...
                <div className="text-sm text-gray-500">Get our latest updates</div>
              </div>
            </Button>
          </CardContent>
        </Card>
      ...
      <footer className="mt-auto">
        <Input type="text" placeholder="Search for features, FAQs, etc." className="mb-4" />
